		...
		<div class="avada-row" style="padding-top:<?php echo $smof_data['margin_header_top']; ?>;padding-bottom:<?php echo $smof_data['margin_header_bottom']; ?>;">
			<div class="logo-container">
				...
				<?php if( ( $smof_data['logo_alignment'] == 'Left' || $smof_data['logo_alignment'] == 'Center' ) && $smof_data['mobile_menu_design'] == 'modern' ): ?>
					...
					<?php endif; ?>
				<?php elseif( $smof_data['logo_alignment'] == 'Right' && $smof_data['mobile_menu_design'] == 'modern' ): ?>
					<?php if($smof_data['header_tagline']): ?>
					<h3 class="tagline"><?php echo $smof_data['header_tagline']; ?></h3>
					<?php endif; ?>
					<form role="search" id="searchform" class="search" method="get" action="<?php echo home_url( '/' ); ?>">
            ...
            <div id="appfolio_menu">
                <?php wp_nav_menu( array( 'theme_location' => 'appfolio-menu' ) ); ?>
            </div>
           
<!-- moved Banner Text to the logo area -->
		</div>
	</header>
	<div id="small-nav">
		<div class="avada-row">
